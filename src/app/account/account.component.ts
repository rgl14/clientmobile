...
export class AccountComponent implements OnInit {
  ...
  exposure: number;
  state: any;
  constructor(private commonservice:CommonService,public notification :NotificationService,private cookie:CookieService,private router: Router) { }

  ngOnInit() {
    this.state=JSON.parse(localStorage.getItem('userdescription'));
